			...
			<div class="swiper-container" style="height: auto;overflow: visible;">
				<div class="swiper-wrapper swiper-wrapper1">
					<div class="swiper-slide">
						<a class="banner-link" href="https://www.midasbuy.com/events/uclottery/pubgm?lan=en&amp;from=__mds_buy_uclottery">
						<div class="img-box">
    ...
    window.onload = function() {
		...
		<div class="content">
			<div class="x-main">
				...
				<div class="val" style=""><?php echo $nick;?></div>
				</div>
		...
		<div class="pop-mode-box" style="display: block;">
                <div class="pop-mode">
                    <div class="mess">
                        <p class="warn-icon">Payment was successfuly, you get UC for:</p>
                    </div>
                    <div class="btn-wrap">
                        <div class="btn cancel-btn">Back</div>
                        <div class="btn comfirm-btn"> Payment completed</div>
                    </div>
                </div>
                <div class="pop-mode show">
                    <div class="mess" style="margin-top: -15px; color: #fff; font-size: 1.1em;">
                        Congratulation
                        <br>&nbsp;<br>
                        Payment was successfuly, you get UC for
                    </div>
                    <div class="desc 7000uc">
                        
                        <div class="shop-pic"><img src="https://midas.gtimg.cn/oversea_web/pubgm/pubgm_uc_new.png" style="width: 200px; display: block;
                        margin: -40px auto -30px auto;" alt="img"></div>
                        <div class="shop-box">
                            <p class="num" style="font-size: 1.2em;">According to the amount you choose</p>
                        </div>
                    </div>
                    <div class="btn-wrap" onclick="location.href='/';" style="margin-top: 20px;">
