		...
		<div class="content">
			<div class="x-main">
				...
				<div class="tab-nav-box">
					...
					<div class="n-box">
					<div class="input-box">
					<input type="text" name="playid" id="playid" maxlength="20" placeholder="Please enter Player ID" class="input" autocomplete="off" required>
					<!---->
					...
					<p cr="playerid_find" class="help-tips find-id-btn" v-if="isEditStatus" @click="showFindOpenidPop">Couldn&#39;t find your Player ID?</p>
				</div>
			...
			<div class="pay-sec">
				...
				<div class="x-main">
					<div class="right">
						...
						<div class="pay-btn" @click="pay" v-bind:class="{ disable: isEditStatus }">Pay now</div>
					</div>
				</div>
			</div>
		</div>
